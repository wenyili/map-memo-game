import type { RealTimeVADOptions } from "@/app/lib/vad-web"
import { MicVAD, defaultRealTimeVADOptions } from "@/app/lib/vad-web"
...
function useOptions(
  ...
  const reactOptions = _filter(Object.keys(defaultReactOptions || {}), options) as ReactOptions
  const vadOptions = _filter(Object.keys(defaultRealTimeVADOptions || {}), options) as RealTimeVADOptions
